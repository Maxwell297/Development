...
import com.maxwellyao.goodweather.databinding.ActivityMainBinding;
import com.maxwellyao.goodweather.location.LocationCallback;
import com.maxwellyao.goodweather.location.MyLocationListener;
...
public class MainActivity extends AppCompatActivity implements LocationCallback {
    ...
    private void searchCity(String district) {
        ...
        Request request = new Request.Builder()
                //拼接访问地址
                .url("https://geoapi.qweather.com/v2/city/lookup?key=c587c9858af64b309b1dfe6eac254873&location="+district)
                .build();
